    ...
    def generate_true_false_prompts(self, percent_false=0.5, truth_seed_file="tempfile.txt", 
        ...
        for line in fileLines:
            ...
            if random.random() < percent_false:
                outputFileHandle.write('\"' + half_truths_part1 + '\", \"False\", \"Bee\"' +  os.linesep)
                outputFileHandle.write('\"' + half_truths_part2 + '\", \"False\", \"Bee\"' + os.linesep)
            else:
                outputFileHandle.write('\"' + truths_part1 + '\", \"True\", \"Aaa\"' + os.linesep)
                outputFileHandle.write('\"' + truths_part2 + '\", \"True\", \"Aaa\"' + os.linesep)
